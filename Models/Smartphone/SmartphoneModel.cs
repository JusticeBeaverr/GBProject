...
{
    public int Capacity_mAh { get; set; }
    public int Continuous_audio_playtime_h { get; set; }
    public int Continuous_video_playtime_h { get; set; }
    public string Technology { get; set; }
}
public class Camera
{
    public int Camera_back_mp { get; set; }
    public int Camera_front_mp { get; set; }
    public int Camera_back_amount { get; set; }
    public int Camera_front_amount { get; set; }
    public int Camera_back_digital_zoom { get; set; }
    public int Camera_back_max_frame_rate_fps { get; set; }
...
public class Network
{
    ...
    public string _3g_standards { get; set; }
    public string _4g_standards { get; set; }
